```
1.Although Columbus knew the earth was round, he could not imagine ____.
(A) how was it large
(B) how large it was
...
4. The fact ____ the forests of North America are shrinking almost as fast as are those of the Amazon Basin is largely ignored by the American people.
(A) of
(B) which
(C) is that
(D) that
...
(C) what
(D) that
6. Riding the rapids down the Colorado, Captain Powell was determined to prove ____ could be traversed.
...
(C) how
(D) that
9. ____ after lying dormant for hundreds of years is hard to believe.
...
(C) she is
(D) she can
11. After comparing the two answer sheets, the teacher came to the conclusion ____ in the exam.
...
(C) that
(D) that there
15.Have you wondered whether ____ too late to change your job?
(A) it is
(B) is it
(C) that it is
(D) is
16. ____ is impossible to tell now.
(A) When will it snow
(B) Whether will snow
(C) When it snows
