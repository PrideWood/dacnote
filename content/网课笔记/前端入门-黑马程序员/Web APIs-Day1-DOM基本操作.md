---
date created: 2024-02-19T13:19:30+08:00
date modified: 2024-02-21T12:08:09+08:00
---
复习：
...
声明变量优先使用 const，如果后面发现它是需要修改的，再改为 let，建议**数组和对象优先使用 const 来声明**
...
![guide.png](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/guide.png)
...
![demo.gif](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/demo.gif)
...
![web-api.jpg](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/web-api.jpg)
...
1. querySelector 满足条件的**第一个元素**
2. querySelectorAll 满足条件的**元素集合 返回伪数组**
3. 了解其他方式
   1. getElementById
...
<body>
  ...
  <script>
  	...
  	const lis = document.querySelectorAll('ul li')  // 获取第一个p元素
  </script>
</body>
</html>
```
...
案例：[年会抽奖](C:\Users\24742\Desktop\practice\WebAPIs\Day1-随机抽奖案例.html)
...
案例：[用户注册倒计时效果](C:\Users\24742\Desktop\practice\WebAPIs\Day1-用户注册倒计时.html)

## 综合案例

[轮播图定时切换](C:\Users\24742\Desktop\practice\WebAPIs\Day1-综合案例：轮播图定时版.html)
