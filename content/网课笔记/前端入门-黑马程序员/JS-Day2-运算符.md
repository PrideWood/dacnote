...
date modified: 2024-02-11T15:08:32+08:00
---
...
1. ++ 在前和 ++ 在后在单独使用时二者并没有差别，而且**一般开发中我们都是独立使用**
2. ++ 在后（后缀式）我们会使用更多
...
逻辑运算符里的短路：只存在于 `&&` 和 `||` 中，当满足一定条件则右边代码不会执行
`&&` ：左边为 false 就短路 
`||` ：左边为 true 就短路   ^fa14cd

只有 5 个值是 false，其余均为真：`false`, `0`, `''`（空）, `undefined`, `none`
...
![image.png](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/20240211150752.png)
...
- **语句**是JS整句或命令，JS语句是以分号结束（可以省略）

![1671017924981.png](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/1671017924981.png)

程序三大流程控制语句：顺序结构、分支结构、循环结构
![image.png](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/20240212205441.png)
...
小括号内的结果若不是布尔类型时，会发生**类型转换为布尔值**，类似 Boolean()
...
1. switch case 语句一般用于**等值判断**, if 适合于**区间判断**
...
练习：[简单计算器](C:\Users\24742\Desktop\practice\js\JS-Day2-简单计算器.html)
...
![1671018781557.png](https://pictures-1323793543.cos.ap-nanjing.myqcloud.com/pics/1671018781557.png)
